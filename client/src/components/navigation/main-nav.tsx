          ...
          <div className="flex items-center gap-3">
            {user ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56 bg-gray-900 border-gray-800">
                  ...
                  <DropdownMenuItem asChild className="text-gray-300 focus:text-cyan-400 focus:bg-cyan-500/10">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56 bg-gray-900 border-gray-800">
                ...
                {navLinks.map((link) => (
                  <DropdownMenuItem key={link.href} asChild className="text-gray-300 focus:text-cyan-400 focus:bg-cyan-500/10">
                ...
                <DropdownMenuSeparator className="bg-gray-800" />
                <DropdownMenuItem onClick={toggleTheme} className="cursor-pointer text-gray-300 focus:text-cyan-400 focus:bg-cyan-500/10">
                  {theme === "light" ? (
                    <>
