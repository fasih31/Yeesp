      ...
      <div className="max-w-7xl mx-auto px-6 py-12 mt-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
          {[
            ...
            <div key={i} className="text-center p-6 rounded-2xl bg-primary/5 border border-primary/20 animate-scale-in" style={{ animationDelay: `${i * 0.1}s` }}>
        ...
        <div className="bg-gradient-to-br from-primary/5 to-secondary/5 rounded-lg p-12 mb-16 border border-primary/10">
